  ...
  return (
    <div className="App">
      ...
      <section id="contact" className="section-bg Contact">
        ...
        <div className="contact-wrapper">
          <div className="contact-item">
            <span>📧</span> <a href="mailto:cineeditvala@gmail.com">Cineeditvala mail</a>
          </div>
          <div className="contact-item">
            <span>🅾★</span> <a href="https://www.instagram.com/cineeditvala" target="_blank" rel="noreferrer">Instagram</a>
          </div>
          <div className="contact-item">
            <span>▶</span> <a href="https://www.youtube.com/@cineeditvala" target="_blank" rel="noreferrer">YouTube</a>
          </div>
          <div className="contact-item">
            <span>📞</span> <a href="tel:+919767774450">Call</a>
          </div>
        </div>
      </section>
      ...
      <section id="terms" className="section-bg">
        ...
        <ul>
          <li>All video content is created for client use only.</li>
          <li>Unauthorized use or redistribution is prohibited.</li>
          <li>All projects are subject to delivery timelines agreed upon.</li>
          <li>Payments are non-refundable after project initiation.</li>
        </ul>
      </section>
